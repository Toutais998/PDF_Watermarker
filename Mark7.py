...
class PDFWatermarkRemover:
    def __init__(self, master):
        self.master = master
        self.master.title("PDF 水印去除工具 Mark7")
    ...
    def _find_text_watermarks(self, page, page_idx: int) -> List[WatermarkInfo]:
        ...
        for block in text_dict.get("blocks", []):
            ...
            for line in block["lines"]:
                ...
                if keyword_hit or rotated or footer_qr_text or (in_edge and color_score) or (large_center and keyword_hit):
